...
func (repo *RestUsersRepository) UpdateUserAccount(bvsDTO *BuyVideoSagaDTO) error {

	url := "http://127.0.0.1:8082/user/ammount/update"
...
func (repo *RestUsersRepository) RollbackUpdateUserAccount(bvsDTO *BuyVideoSagaDTO) error {

	url := "http://127.0.0.1:8082/user/ammount/rollback"
	jsonBytes, err := json.Marshal(bvsDTO)
	if err != nil {
		return err
	}
	...
	//a rollback 2 times consecutevily.
